...
<Frame>
  ![la page « Gestion des membres » avec ses onglets et le bouton « Inviter un membre ».](/images/gestion-des-membres.webp)
</Frame>
...
| **Admin facturation** | Gère les membres, l'abonnement, les paramètres de l'organisation et les intégrations, sans accès aux fonctionnalités produit. N'occupe pas de place |
...
Le même menu propose **Retirer**. Une confirmation prévient que « le membre perdra immédiatement l'accès à l'organisation ».
...
- Un admin facturation ne consomme pas de place et n'a aucun accès au produit : il est redirigé vers la page des membres. Il gère en revanche les paramètres de l'organisation et les intégrations.
- La dernière personne pouvant gérer l'organisation, administrateur ou admin facturation, ne peut être ni rétrogradée ni retirée.

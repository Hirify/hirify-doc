...
<Note>
Aucun email ne vous prévient qu'un entretien est traité. Restez sur la page, la liste se met à jour d'elle-même. Le centre de **Notifications**, dans le menu de votre compte, signale aussi la fin de la transcription et celle du compte rendu.
</Note>

...
La page **Sécurité** réunit deux choses : votre mot de passe et vos jetons d'accès. Elle s'ouvre depuis **Paramètres**, en bas de la barre latérale, puis **Sécurité**. L'authentification unique se met en place avec l'équipe Hirify.
...
<Frame>
  ![page Paramètres → Sécurité, section « Mot de passe »](/images/parametres-securite.webp)
</Frame>
